document.addEventListener('DOMContentLoaded', function () {
    ...
    fields.forEach(function (field) {
      ...
      if (field.hasAttribute('required') && value === '') {
        ...
        if (!errorMessage && maxLength && value.length > parseInt(maxLength)) {
          errorMessage = getFieldLabel(field) + ' must be no more than ' + maxLength + ' characters.';
        }
        ...
        if (!errorMessage && pattern) {
          ...
          if (!regex.test(value)) {
            errorMessage = field.getAttribute('title') || getFieldLabel(field) + ' format is invalid.';
          }
        }
      }
  ...
  document.body.addEventListener('blur', function (e) {
    ...
    const existingError = field.parentNode && field.parentNode.querySelector('.form-error-message');
    if (existingError) {
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "EM graphic משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    (function() {
        ...
        function initContactForm() {
            ...
            try {
                ...
                const payload = {
                    websiteId: '47b56033-0542-49a9-bf63-846c09e41ba2',
                    name: name,
                    email: email,
                    subject: subject,
                    message: message,
                ...
                if (result.success) {
                    ...
                    if (result.thankYouPagePath && result.ticketNumber) {
                        ...
                        if (isPreviewMode && window.ZAPPY_CONFIG) {
                            ...
                            const websiteId = window.ZAPPY_CONFIG.websiteId || '47b56033-0542-49a9-bf63-846c09e41ba2';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '47b56033-0542-49a9-bf63-846c09e41ba2';
